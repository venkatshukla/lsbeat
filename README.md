...
`${GOPATH}/src/github.com/venkatshukla/lsbeat`
...
```
git remote set-url origin https://github.com/venkatshukla/lsbeat
...
```
mkdir -p ${GOPATH}/src/github.com/venkatshukla/lsbeat
git clone https://github.com/venkatshukla/lsbeat ${GOPATH}/src/github.com/venkatshukla/lsbeat
```
